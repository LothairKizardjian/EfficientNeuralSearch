...
class MicroController(Controller):
    ...
    def _create_params(self):
        ...
        with tf.variable_scope(self.name, initializer=initializer):
            ...
            with tf.variable_scope("softmax"):
                ...
                b_init = np.array(
                    [10.0, 10.0] + [0] * (self.num_branches - 2), dtype=np.float32
                )
    ...
    def _build_sampler(self, prev_c=None, prev_h=None, use_bias=False):
        ...
        def _body(
            ...
            for i in range(2):  # index_1, index_2
                ...
                index = tf.multinomial(logits, 1)  # Deprecated
            ...
            for i in range(2):  # op_1, op_2
                ...
                op_id = tf.multinomial(logits, 1)  # Deprecated
                # op_id = tf.random.categorical(logits, 1)

                op_id = tf.cast(op_id, tf.int32)
    ...
    def build_trainer(self, child_model):
        ...
        self.valid_acc = tf.cast(child_model.valid_shuffle_acc, tf.float32) / tf.cast(
