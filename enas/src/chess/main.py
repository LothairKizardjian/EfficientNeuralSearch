...
from src.chess.general_child import GeneralChild
from src.chess.general_controller import GeneralController
from src.chess.micro_child import MicroChild
from src.chess.micro_controller import MicroController
...
DEFINE_integer(
    "controller_train_every", 2, "train the controller after this number of epochs"
)
        ...
        with tf.train.SingularMonitoredSession(
            ...
            while True:
                ...
                if actual_step % ops["eval_every"] == 0:
                    if (
                        FLAGS.controller_training
                        and epoch % FLAGS.controller_train_every == 0
                    ):
                        print("Epoch {}: Training controller".format(epoch))
                        for ct_step in range(
                            FLAGS.controller_train_steps
